	...
	public void customerDetail(){
        System.out.println("Customer Id: "+getCustomerId()+"\n"+
                           ...
                           "Customer Contact: "+getCustomerContact()+"\n"+
                            "Address: "+
                            "Street: "+getCustomerAddress().getStreet()+" City: "+
                            getCustomerAddress().getCity()+" State: "+
                            getCustomerAddress().getState()+" Country: "+
                            getCustomerAddress().getCountry()+" zip: "+
                            getCustomerAddress().getZip());
    }
